...
14. **Demo chart follow-up = existing Story 10-4 (`LUFSReadoutView`), pulled forward.** Its real dependency is 8.1 only (not Epic 11; FR-42 degradation already allows it). The probe file is its seed. Noted in epics.md patch. This story ships ZERO demo code.
