...
extension SwiftPMXCTestObserver: XCTestObservation {
    var testOutputPath: String {
        return "/Users/rterhaar/Dropbox/research/swift/mediadiff/BoomBoomBoomKit/.build/arm64-apple-macosx/debug/testOutput.txt"
    }
...
struct Runner {
    ...
    private static func _runAsyncMain(_ asyncFun: @Sendable @escaping () async throws -> Void)
    #endif
