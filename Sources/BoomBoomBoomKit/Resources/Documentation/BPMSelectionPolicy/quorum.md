...
**When to pick it.** Choose it when you have several windows and you trust consensus over peak loudness — the classic case where a track's true tempo shows up modestly but repeatedly across windows while a distractor spikes hard in just one. It is the natural answer to _maxConfidence_'s over-confident-outlier failure, and it shines on longer files where progressive analysis yields three or more windows to vote. The more windows in play, the more reliable the quorum signal becomes.
